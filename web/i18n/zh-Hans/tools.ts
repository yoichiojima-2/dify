const translation = {
  ...
  skill: {
    create: {
      ...
      gitBranch: '分支',
      displayName: '显示名称',
      displayNamePlaceholder: '可选的自定义名称',
      displayNameHint: '留空将使用 SKILL.md 中的技能名称',
      uploadFile: '技能包',
      uploadHint: '点击选择 .zip 文件',
      uploadFormat: '包含 SKILL.md 的 ZIP 压缩包',
      install: '安装',
    },
    hasScripts: '有脚本',
    noScripts: '无脚本',
    disabled: '已禁用',
    delete: '移除技能',
    deleteConfirmTitle: '确定要移除 {{skill}} 吗？',
    version: '版本',
    author: '作者',
    source: '来源',
    license: '许可证',
    ...
    errors: {
      gitUrlRequired: '请输入 Git URL',
      fileRequired: '请选择文件',
      invalidFileType: '仅支持 .zip 文件',
