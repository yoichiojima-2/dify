const translation = {
  ...
  skill: {
    create: {
      cardTitle: 'Add Skill',
      cardLink: 'Learn about Agent Skills',
      title: 'Install Skill',
      fromGit: 'From Git',
      fromUpload: 'Upload',
      ...
      displayNamePlaceholder: 'Optional custom name',
      displayNameHint: 'Leave blank to use the skill name from SKILL.md',
      uploadFile: 'Skill Package',
      uploadHint: 'Click to select a .zip file',
      uploadFormat: 'ZIP archive containing SKILL.md',
      install: 'Install',
    },
    ...
    disabled: 'Disabled',
    delete: 'Remove Skill',
    deleteConfirmTitle: 'Would you like to remove {{skill}}?',
    version: 'Version',
    author: 'Author',
    source: 'Source',
    license: 'License',
